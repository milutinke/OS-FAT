...
public class DiskUtil {
	...
	/**
	 * Extract a part of an array, and return it as a new array. If there is
	 * overhead, it will be zero-filled
	 * 
	 ...
	 * @return The extracted data from the larger array. If {@code start+length} is
	 *         larger than the length of the original array, the remainder of data
	 *         will be zero-filled.
	 */
